"""Cross-platform CLI for BPSR crowd data operations."""
...
def smoke() -> None:
    """
    Run smoke tests: boot temporary API, seed key, ingest, and verify retrieval.
    
    This function is equivalent to scripts/smoke.py but designed as a CLI entry point
    that works cross-platform (Windows, macOS, Linux).
    """
    ...
    # Apply migrations and seed API key
